		...
		<div className="car-card group">
			...
			<div className="relative flex w-full mt-2">
                ...
                <div className="car-card__btn-container">
                    <CustomButton handleClick={()=> setIsOpen(true)} title="View More" containerStyles="bg-primary-blue w-full py-[16px] rounded-full" textStyles="text-white font-[14px] leading-[17px] font-bold" rightIcon="/right-arrow.svg" />
                </div>
			</div>

            <CardDetails car={car} isOpen={isOpen} closeModal={()=> setIsOpen(false)} />
		</div>
	);
}
